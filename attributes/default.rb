...
default[:raintank_stack][:metric_tank][:nsqd_addr] = []
...
default[:raintank_stack]['tsdb']['real_ssl_cert'] = false
default[:raintank_stack]['tsdb']['ssl_data_bag'] = node[:raintank_stack][:grafana_domain]
